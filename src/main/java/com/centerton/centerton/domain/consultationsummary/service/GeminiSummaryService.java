...
public class GeminiSummaryService {
    ...
    private String createTranscriptPrompt(
        ...
        return """
                ...
                7. 각 instruction은 300자를 넘지 않습니다.
                8. 불명확하거나 기록에 없는 내용은 추측하지 않습니다.
                9. 인사, 반복 발화, 자막 오류로 보이는 단편은 제외합니다.
                10. JSON 객체 하나만 반환하세요.
                11. 마크다운 코드 블록이나 추가 설명을 사용하지 마세요.
    ...
    private String createMergePrompt(
        ...
        return """
                ...
                6. instructions는 최대 10개입니다.
                7. 각 instruction은 300자를 넘지 않습니다.
                8. 부분 요약에 없는 내용은 추측하지 않습니다.
                9. JSON 객체 하나만 반환합니다.
                10. JSON 앞뒤에 설명이나 마크다운을 작성하지 않습니다.
