...
import com.centerton.centerton.global.util.PhoneNumberFormatter;
    ...
    public record PatientInfo(
        ...
        private static PatientInfo from(Patient patient) {
            return new PatientInfo(
                    ...
                    patient.getGender() == null ? null : patient.getGender().getDisplayName()
            );
        }
    }
    ...
    public record EmergencyContacts(
        ...
        private static EmergencyContacts from(AftercareCase aftercareCase) {
            return new EmergencyContacts(
                    PhoneNumberFormatter.toInternationalKoreanPhoneNumber(aftercareCase.getClinicPhoneNumber()),
                    PhoneNumberFormatter.toInternationalKoreanPhoneNumber(aftercareCase.getGuardianPhoneNumber())
            );
        }
    }
