...
public enum AiChatErrorCode implements BaseResponseCode {
    ...
    QUESTION_REQUIRED("AI_CHAT_400_1", BAD_REQUEST, "증상 문의 내용을 입력해주세요."),
    QUESTION_TOO_LONG("AI_CHAT_400_2", BAD_REQUEST, "증상 문의 내용은 1000자 이하로 입력해주세요."),
    IMAGE_EMPTY("AI_CHAT_400_3", BAD_REQUEST, "빈 이미지는 첨부할 수 없습니다."),
    IMAGE_TOO_LARGE("AI_CHAT_413_1", 413, "첨부 이미지는 10MB를 초과할 수 없습니다."),
